...
if uploaded_file is not None:
    ...
    try:
        ...
        status_text.text("Menyimpan file audio...")
        ...
        status_text.text("Membuat waveform...")
        ...
        status_text.text("Membuat spectrogram...")
        ...
        status_text.text("Ekstraksi fitur audio...")
        ...
        status_text.text("Melakukan prediksi emosi...")
